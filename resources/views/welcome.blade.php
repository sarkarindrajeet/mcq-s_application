...
<body class="antialiased" id="body" data-spy="scroll" data-target=".navbar" data-offset="100">
        ...
        <nav class="navbar navbar-expand-lg pl-3 pl-sm-0" id="navbar">
            <div class="container">
                <div class="navbar-brand-wrapper d-flex w-100">
                    <img src="{{ url('assets/images/Group5.svg')}}" alt="">
    ...
    <div class="banner">
        <div class="container">
            <h1 class="font-weight-semibold">Welcome to for our test</h1>
            <h6 class="font-weight-normal text-muted pb-3">We are taking students assesment tests in very reliable and fast way</h6>
            <div>
            ...
            <img src="{{ url('assets/images/Group126.svg')}}" alt="" class="img-fluid" style="width: 50%;">
        </div>
    </div>
</body>
